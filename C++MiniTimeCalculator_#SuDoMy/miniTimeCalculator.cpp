...
// De-plus vérifier que le N° de dossard, n'est pas déjà entrez


// Crée un RegExp, pour accepter le bon format horraire
// HH:MM:SS.dcm (heures, minutes, secondes, dixièmes, centièmes, milllièmes).
__int64 iStartHour = 0;
__int64 iEndHour = 0;
//---------
// Convertir String to int obligatoire pour recuperer les Text entrez par Chronométreur
